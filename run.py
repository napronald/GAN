...
parser.add_argument("--dataset_root", type=str, default="/path", help="Root directory of the dataset.")
parser.add_argument("--num_epoch", type=int, default=200, help="Number of epochs for training.")
...
parser.add_argument("--G_lr", type=float, default=0.0005, help="Learning rate for the Generator.")
parser.add_argument("--D_step", type=int, nargs="+", default=[50, 125], help="Milestones for the Discriminator scheduler.")
parser.add_argument("--G_step", type=int, nargs="+", default=[50, 125], help="Milestones for the Generator scheduler.")
...
parser.add_argument("--content_loss_lambda", type=float, default=0.5, help="Lambda for content loss.")
